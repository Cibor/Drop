...
public class AudioSettingStage extends Stage {
    ...
    public AudioSettingStage(MainMenuScreen mainMenuSuper, final Skin skin, final TextureRegionDrawable backScreen) {
        ...
        MusicSli.setValue(mainMenu.getGame().getOurMusic().getMusicVolume() * 100);
        ...
        Label MusicCount = new Label(((Float)(mainMenu.getGame().getOurMusic().getMusicVolume() * 100)).toString(), skin, "subtitle");
        ...
        MusicSli.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                mainMenu.getGame().getOurMusic().setMusicVolume(((Slider) actor).getValue()/100);
            }
        });
        ...
        SoundSli.setValue(mainMenu.getGame().getOurMusic().getSoundVolume() * 100);
        ...
        Label SoundCount = new Label(((Float)(mainMenu.getGame().getOurMusic().getSoundVolume() * 100)).toString(), skin, "subtitle");
        ...
        SoundSli.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                mainMenu.getGame().getOurMusic().setSoundVolume(((Slider) actor).getValue()/100);
            }
        });
